...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ServiceOIDCProviderSpec)(nil), (*kops.ServiceOIDCProviderSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_ServiceOIDCProviderSpec_To_kops_ServiceOIDCProviderSpec(a.(*ServiceOIDCProviderSpec), b.(*kops.ServiceOIDCProviderSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.ServiceOIDCProviderSpec)(nil), (*ServiceOIDCProviderSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_ServiceOIDCProviderSpec_To_v1alpha2_ServiceOIDCProviderSpec(a.(*kops.ServiceOIDCProviderSpec), b.(*ServiceOIDCProviderSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ClusterSpec_To_kops_ClusterSpec(in *ClusterSpec, out *kops.ClusterSpec, s conversion.Scope) error {
	...
	if in.ServiceOIDCProvider != nil {
		...
		*out = new(kops.ServiceOIDCProviderSpec)
		if err := Convert_v1alpha2_ServiceOIDCProviderSpec_To_kops_ServiceOIDCProviderSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.ServiceOIDCProvider = nil
	}
	return nil
}
...
func autoConvert_kops_ClusterSpec_To_v1alpha2_ClusterSpec(in *kops.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	if in.ServiceOIDCProvider != nil {
		...
		*out = new(ServiceOIDCProviderSpec)
		if err := Convert_kops_ServiceOIDCProviderSpec_To_v1alpha2_ServiceOIDCProviderSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.ServiceOIDCProvider = nil
...
func autoConvert_v1alpha2_ServiceOIDCProviderSpec_To_kops_ServiceOIDCProviderSpec(in *ServiceOIDCProviderSpec, out *kops.ServiceOIDCProviderSpec, s conversion.Scope) error {
	out.IssuerHostPath = in.IssuerHostPath
	return nil
}

// Convert_v1alpha2_ServiceOIDCProviderSpec_To_kops_ServiceOIDCProviderSpec is an autogenerated conversion function.
func Convert_v1alpha2_ServiceOIDCProviderSpec_To_kops_ServiceOIDCProviderSpec(in *ServiceOIDCProviderSpec, out *kops.ServiceOIDCProviderSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_ServiceOIDCProviderSpec_To_kops_ServiceOIDCProviderSpec(in, out, s)
}
...
// Convert_kops_ServiceOIDCProviderSpec_To_v1alpha2_ServiceOIDCProviderSpec is an autogenerated conversion function.
func Convert_kops_ServiceOIDCProviderSpec_To_v1alpha2_ServiceOIDCProviderSpec(in *kops.ServiceOIDCProviderSpec, out *ServiceOIDCProviderSpec, s conversion.Scope) error {
	return autoConvert_kops_ServiceOIDCProviderSpec_To_v1alpha2_ServiceOIDCProviderSpec(in, out, s)
}
