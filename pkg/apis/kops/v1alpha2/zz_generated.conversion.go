...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Bottlerocket)(nil), (*kops.Bottlerocket)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_Bottlerocket_To_kops_Bottlerocket(a.(*Bottlerocket), b.(*kops.Bottlerocket), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.Bottlerocket)(nil), (*Bottlerocket)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_Bottlerocket_To_v1alpha2_Bottlerocket(a.(*kops.Bottlerocket), b.(*Bottlerocket), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ImageFamily)(nil), (*kops.ImageFamily)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_ImageFamily_To_kops_ImageFamily(a.(*ImageFamily), b.(*kops.ImageFamily), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.ImageFamily)(nil), (*ImageFamily)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_ImageFamily_To_v1alpha2_ImageFamily(a.(*kops.ImageFamily), b.(*ImageFamily), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_Bottlerocket_To_kops_Bottlerocket(in *Bottlerocket, out *kops.Bottlerocket, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha2_Bottlerocket_To_kops_Bottlerocket is an autogenerated conversion function.
func Convert_v1alpha2_Bottlerocket_To_kops_Bottlerocket(in *Bottlerocket, out *kops.Bottlerocket, s conversion.Scope) error {
	return autoConvert_v1alpha2_Bottlerocket_To_kops_Bottlerocket(in, out, s)
}

func autoConvert_kops_Bottlerocket_To_v1alpha2_Bottlerocket(in *kops.Bottlerocket, out *Bottlerocket, s conversion.Scope) error {
	return nil
}

// Convert_kops_Bottlerocket_To_v1alpha2_Bottlerocket is an autogenerated conversion function.
func Convert_kops_Bottlerocket_To_v1alpha2_Bottlerocket(in *kops.Bottlerocket, out *Bottlerocket, s conversion.Scope) error {
	return autoConvert_kops_Bottlerocket_To_v1alpha2_Bottlerocket(in, out, s)
}
...
func autoConvert_v1alpha2_ImageFamily_To_kops_ImageFamily(in *ImageFamily, out *kops.ImageFamily, s conversion.Scope) error {
	if in.Bottlerocket != nil {
		in, out := &in.Bottlerocket, &out.Bottlerocket
		*out = new(kops.Bottlerocket)
		if err := Convert_v1alpha2_Bottlerocket_To_kops_Bottlerocket(*in, *out, s); err != nil {
			return err
		}
	} else {
...
// Convert_v1alpha2_ImageFamily_To_kops_ImageFamily is an autogenerated conversion function.
func Convert_v1alpha2_ImageFamily_To_kops_ImageFamily(in *ImageFamily, out *kops.ImageFamily, s conversion.Scope) error {
	return autoConvert_v1alpha2_ImageFamily_To_kops_ImageFamily(in, out, s)
}

func autoConvert_kops_ImageFamily_To_v1alpha2_ImageFamily(in *kops.ImageFamily, out *ImageFamily, s conversion.Scope) error {
	if in.Bottlerocket != nil {
		in, out := &in.Bottlerocket, &out.Bottlerocket
		*out = new(Bottlerocket)
		if err := Convert_kops_Bottlerocket_To_v1alpha2_Bottlerocket(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Bottlerocket = nil
...
// Convert_kops_ImageFamily_To_v1alpha2_ImageFamily is an autogenerated conversion function.
func Convert_kops_ImageFamily_To_v1alpha2_ImageFamily(in *kops.ImageFamily, out *ImageFamily, s conversion.Scope) error {
	return autoConvert_kops_ImageFamily_To_v1alpha2_ImageFamily(in, out, s)
}
...
func autoConvert_v1alpha2_InstanceGroupSpec_To_kops_InstanceGroupSpec(in *InstanceGroupSpec, out *kops.InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.ImageFamily != nil {
		...
		*out = new(kops.ImageFamily)
		if err := Convert_v1alpha2_ImageFamily_To_kops_ImageFamily(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.ImageFamily = nil
...
func autoConvert_kops_InstanceGroupSpec_To_v1alpha2_InstanceGroupSpec(in *kops.InstanceGroupSpec, out *InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.ImageFamily != nil {
		in, out := &in.ImageFamily, &out.ImageFamily
		*out = new(ImageFamily)
		if err := Convert_kops_ImageFamily_To_v1alpha2_ImageFamily(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.ImageFamily = nil
